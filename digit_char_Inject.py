...
class digit_char_Inject:
    ...
    def req_digit_payload(self, url):
        ...
        for i in range(len(self.paramsList)):
            payload1_param = self.paramsList[i] + ' and 1=1'     # 构造其中一个参数的payload
            ...
            payload2_param = self.paramsList[i] + ' and 1=2'
...
url1 = "http://demo.sqli.com/Less-3/?id=1&a=aasdf&b=callback"
